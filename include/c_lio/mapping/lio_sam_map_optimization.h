...
#ifndef C_LIO_LIO_SAM_MAP_OPTIMIZATION_H
#define C_LIO_LIO_SAM_MAP_OPTIMIZATION_H
...
class c_lio::LioSamMapOptimizationNode : public rclcpp::Node
{
...
private:
  ...
  struct Keyframe
  {
    ...
    c_lio::AppearanceDescriptor appearance_desc;
    // GPS local coords
  ...
  // --- Callbacks ---
  void callbackKeyframe(const c_lio::msg::KeyframeStamped::SharedPtr msg);
  ...
  void autoSave();
  void savePCD(std::shared_ptr<c_lio::srv::SavePCD::Request> req,
  ...
  // ==================== ROS ====================
  // Subscribers
  rclcpp::Subscription<c_lio::msg::KeyframeStamped>::SharedPtr keyframe_sub_;
  ...
  // Runtime mode mirror (from OdomNode's latched c_lio/mode). When false
  ...
  // Service
  rclcpp::Service<c_lio::srv::SavePCD>::SharedPtr save_pcd_srv_;
  ...
  c_lio::AppearanceEngine appearance_;
...
#endif // C_LIO_LIO_SAM_MAP_OPTIMIZATION_H
