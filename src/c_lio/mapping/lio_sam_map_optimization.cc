/***********************************************************
 *                                                         *
 * LIO-SAM-style Map Optimization for C_LIO                 *
 *                                                         *
...
#include "c_lio/mapping/lio_sam_map_optimization.h"
...
c_lio::LioSamMapOptimizationNode::LioSamMapOptimizationNode(const rclcpp::NodeOptions &options)
    : Node("c_lio_lio_sam_map_opt_node", options)
{
    ...
    this->keyframe_sub_ = this->create_subscription<c_lio::msg::KeyframeStamped>(
        "keyframe_stamped", 100,
        std::bind(&c_lio::LioSamMapOptimizationNode::callbackKeyframe, this, std::placeholders::_1),
        kf_sub_opt);
    ...
    if (this->gps_enabled_)
    {
        ...
        this->gps_sub_ = this->create_subscription<sensor_msgs::msg::NavSatFix>(
            ...
            std::bind(&c_lio::LioSamMapOptimizationNode::callbackGPS, this, std::placeholders::_1),
            gps_sub_opt);
    ...
    this->odom_sub_ = this->create_subscription<nav_msgs::msg::Odometry>(
        ...
        std::bind(&c_lio::LioSamMapOptimizationNode::callbackOdom, this, std::placeholders::_1),
        odom_sub_opt);
    ...
    if (this->tf_map_odom_source_ == "lio_sam_opt")
    {
        ...
        this->tf_timer_ = this->create_wall_timer(
            ...
            std::bind(&c_lio::LioSamMapOptimizationNode::publishMapToOdomTF, this));
    ...
    this->save_pcd_srv_ = this->create_service<c_lio::srv::SavePCD>(
        "save_corrected_pcd",
        std::bind(&c_lio::LioSamMapOptimizationNode::savePCD, this, std::placeholders::_1, std::placeholders::_2),
    ...
    this->loop_timer_ = this->create_wall_timer(
        ...
        std::bind(&c_lio::LioSamMapOptimizationNode::loopClosureThread, this));
    ...
    this->vis_timer_ = this->create_wall_timer(
        ...
        std::bind(&c_lio::LioSamMapOptimizationNode::publishCorrectedData, this));
    ...
    if (!this->map_path_.empty() && this->auto_save_interval_ > 0.)
    {
        this->auto_save_timer_ = this->create_wall_timer(
            ...
            std::bind(&c_lio::LioSamMapOptimizationNode::autoSave, this));
    }

    // --- Runtime mode mirror (latched c_lio/mode from OdomNode) ---
...
c_lio::LioSamMapOptimizationNode::~LioSamMapOptimizationNode()
{
    this->saveOnShutdown();
    delete this->isam_;
}
...
void c_lio::LioSamMapOptimizationNode::getParams()
{
    c_lio::declare_param(this, "debug/lio_sam_map_opt", this->debug_, false);
    c_lio::declare_param(this, "debug/print_lio_sam_opt", this->debug_print_, false);
    c_lio::declare_param(this, "frames/odom", this->odom_frame_, std::string("odom"));
    ...
    c_lio::declare_param(this, "map_correction", this->map_correction_enabled_, true);

    // Loop closure detection (LIO-SAM style)
    c_lio::declare_param(this, "loop_detection_period_ms", this->loop_detection_period_ms_, 1000);
    c_lio::declare_param(this, "loop_closure/search_radius", this->history_keyframe_search_radius_, 15.0);
    c_lio::declare_param(this, "loop_closure/search_time_diff", this->history_keyframe_search_time_diff_, 30.0);
    c_lio::declare_param(this, "loop_closure/search_num", this->history_keyframe_search_num_, 25);
    c_lio::declare_param(this, "loop_closure/fitness_score_threshold", this->history_keyframe_fitness_score_, 0.3);
    c_lio::declare_param(this, "loop_closure/min_keyframe_gap", this->min_keyframe_gap_, 30);

    // SC++ (secondary loop closure)
    c_lio::declare_param(this, "sc/enabled", this->sc_enabled_, true);
    double sc_mr = 20.0;
    c_lio::declare_param(this, "sc/max_range", sc_mr, 20.0);
    this->sc_max_range_ = static_cast<float>(sc_mr);
    double sc_dt = 0.5;
    c_lio::declare_param(this, "sc/distance_threshold", sc_dt, 0.5);
    this->sc_distance_threshold_ = static_cast<float>(sc_dt);
    double sc_ght = 0.0;
    c_lio::declare_param(this, "sc/ground_height_threshold", sc_ght, 0.0);
    this->sc_ground_height_threshold_ = static_cast<float>(sc_ght);
    c_lio::declare_param(this, "sc/search_window", this->sc_search_window_, 7);
    ...
    // Init appearance engine for loop closure descriptor
    {
        ...
        this->appearance_.init(c_lio::AppearanceMethod::SC_PLUS_PLUS, ap, this->get_logger());
    }

    // Registration method for loop closure verification
    c_lio::declare_param(this, "registration_method", this->lc_registration_method_, std::string("icp"));
    c_lio::declare_param(this, "icp/max_iterations", this->lc_max_iterations_, 100);
    c_lio::declare_param(this, "icp/max_correspondence_distance", this->lc_max_corr_dist_, 30.0);
    c_lio::declare_param(this, "icp/transformation_epsilon", this->lc_transformation_ep_, 1e-6);
    c_lio::declare_param(this, "gicp/k_correspondences", this->lc_gicp_k_correspondences_, 20);
    c_lio::declare_param(this, "gicp/rotation_epsilon", this->lc_rotation_ep_, 0.01);
    c_lio::declare_param(this, "ndt/resolution", this->ndt_resolution_, 1.0);
    c_lio::declare_param(this, "ndt/num_threads", this->ndt_num_threads_, 4);

    c_lio::declare_param(this, "voxel_leaf_size", this->voxel_leaf_size_, 0.2);

    // GPS
    c_lio::declare_param(this, "gps/enabled", this->gps_enabled_, false);
    c_lio::declare_param(this, "gps/topic", this->gps_topic_, std::string("/gps/fix"));
    c_lio::declare_param(this, "gps/cov_threshold", this->gps_cov_threshold_, 2.0);
    c_lio::declare_param(this, "gps/pose_cov_threshold", this->pose_cov_threshold_, 25.0);
    c_lio::declare_param(this, "gps/use_elevation", this->use_gps_elevation_, false);
    double gps_ma = 5.0;
    c_lio::declare_param(this, "gps/min_accuracy", gps_ma, 5.0);
    this->gps_min_accuracy_ = static_cast<float>(gps_ma);
    double gps_mnf = 0.1;
    c_lio::declare_param(this, "gps/min_noise_floor", gps_mnf, 0.1);
    ...
    c_lio::declare_param(this, "extrinsics/baselink2gps/t", gps_t_vec, gps_t_default);
    ...
    c_lio::declare_param(this, "extrinsics/baselink2gps/rpy", gps_rpy_vec, gps_rpy_default);
    {
    ...
    c_lio::declare_param(this, "gps/gating_mode", this->gps_gating_mode_, std::string("covariance"));
    double gps_lc_r = 20.0;
    c_lio::declare_param(this, "gps/lc_search_radius", gps_lc_r, 20.0);
    this->gps_lc_search_radius_ = static_cast<float>(gps_lc_r);
    double fused_dr = 0.5;
    c_lio::declare_param(this, "gps/fused_drift_rate", fused_dr, 0.5);
    this->fused_drift_rate_ = static_cast<float>(fused_dr);
    double gps_bm = 10.0;
    c_lio::declare_param(this, "gps/buffer_margin", gps_bm, 10.0);
    this->gps_buffer_margin_ = static_cast<float>(gps_bm);

    // Fusion KF
    double fon = 0.01, fcn = 1.0;
    c_lio::declare_param(this, "fusion/odom_noise", fon, 0.01);
    c_lio::declare_param(this, "fusion/correction_noise", fcn, 1.0);
    this->fusion_odom_noise_ = static_cast<float>(fon);
    this->fusion_gps_noise_ = static_cast<float>(fcn);

    // iSAM2
    c_lio::declare_param(this, "isam/relinearize_threshold", this->isam_relinearize_threshold_, 0.1);
    c_lio::declare_param(this, "isam/relinearize_skip", this->isam_relinearize_skip_, 1);
    c_lio::declare_param(this, "isam/batch_optimization", this->batch_optimization_, false);
    c_lio::declare_param(this, "isam/batch_optimization_interval", this->batch_optimization_interval_, 100);

    // Noise model
    c_lio::declare_param(this, "odom_noise/rotation", this->odom_noise_rot_, 0.1);
    c_lio::declare_param(this, "odom_noise/translation", this->odom_noise_trans_, 0.5);
    c_lio::declare_param(this, "odom_prior_noise/rotation", this->odom_prior_noise_rot_, 1.0);
    c_lio::declare_param(this, "odom_prior_noise/translation", this->odom_prior_noise_trans_, 100.0);
    c_lio::declare_param(this, "loop_noise/multiplier", this->loop_noise_multiplier_, 0.001);

    // Map save
    c_lio::declare_param(this, "map/mode", this->map_mode_, std::string("mapping"));
    ...
    c_lio::declare_param(this, "map/auto_save_interval", this->auto_save_interval_, 30.0);
    c_lio::declare_param(this, "map/publish_interval", this->publish_interval_, 5.0);
    c_lio::declare_param(this, "map/global_map_vis_radius", this->global_map_vis_radius_, 1000.0);
}
...
void c_lio::LioSamMapOptimizationNode::publishMapToOdomTF()
{
...
gtsam::Pose3 c_lio::LioSamMapOptimizationNode::isometryToGtsamPose(const Eigen::Isometry3d &iso)
{
    return gtsam::Pose3(gtsam::Rot3(iso.rotation()), gtsam::Point3(iso.translation()));
}

Eigen::Isometry3d c_lio::LioSamMapOptimizationNode::gtsamPoseToIsometry(const gtsam::Pose3 &pose)
{
...
void c_lio::LioSamMapOptimizationNode::callbackKeyframe(
    const c_lio::msg::KeyframeStamped::SharedPtr msg)
{
    ...
    // Cloud from C_LIO is already in world frame
...
void c_lio::LioSamMapOptimizationNode::callbackDeskewed(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
    DeskewedScan scan;
...
void c_lio::LioSamMapOptimizationNode::callbackGPS(const sensor_msgs::msg::NavSatFix::SharedPtr msg)
{
...
void c_lio::LioSamMapOptimizationNode::callbackOdom(const nav_msgs::msg::Odometry::SharedPtr msg)
{
...
bool c_lio::LioSamMapOptimizationNode::getGPSAtTime(double timestamp, GPSMeasurement &out)
{
    std::lock_guard<std::mutex> lock(this->gps_buffer_mtx_);
...
bool c_lio::LioSamMapOptimizationNode::gpsToLocal(double lat, double lon, double alt,
...
void c_lio::LioSamMapOptimizationNode::addGPSFactor(int idx, const Keyframe &kf)
{
...
void c_lio::LioSamMapOptimizationNode::addLoopFactors()
{
...
bool c_lio::LioSamMapOptimizationNode::updateISAM()
{
    try
    {
...
void c_lio::LioSamMapOptimizationNode::batchOptimize()
{
...
void c_lio::LioSamMapOptimizationNode::correctPoses()
{
...
void c_lio::LioSamMapOptimizationNode::loopClosureThread()
{
    if (!this->mapping_active_.load())
        return;
...
bool c_lio::LioSamMapOptimizationNode::detectLoopClosureDistance(int &loop_cur, int &loop_pre)
{
...
bool c_lio::LioSamMapOptimizationNode::detectLoopClosureSC(int &loop_cur, int &loop_pre, int &sc_shift)
{
    if (!this->sc_enabled_)
        return false;
...
bool c_lio::LioSamMapOptimizationNode::detectLoopClosureGPS(int &loop_cur, int &loop_pre)
{
    if (!this->gps_enabled_)
        return false;
...
void c_lio::LioSamMapOptimizationNode::performLoopClosure()
{
    ...
    {
        c_lio::RegistrationParams lc_params;
        ...
        c_lio::RegistrationEngine lc_engine;
        lc_engine.init(c_lio::parseRegistrationMethod(this->lc_registration_method_), lc_params, this->get_logger());
...
void c_lio::LioSamMapOptimizationNode::publishCorrectedData()
{
...
void c_lio::LioSamMapOptimizationNode::publishGlobalMap(
...
void c_lio::LioSamMapOptimizationNode::publishLoopClosureMarkers()
{
...
void c_lio::LioSamMapOptimizationNode::saveGraphMaps(const std::string &save_dir, float leaf_size)
{
...
void c_lio::LioSamMapOptimizationNode::autoSave()
{
...
void c_lio::LioSamMapOptimizationNode::debugPrint()
{
    ...
    printf("+-------------------------------------------------------------------+\n");
    printf("|             C_LIO LIO-SAM Map Optimization Debug                   |\n");
    printf("+-------------------------------------------------------------------+\n");
    printf("| GRAPH                                                             |\n");
...
void c_lio::LioSamMapOptimizationNode::saveOnShutdown()
{
    if (!this->mapping_active_.load())
        return;
    if (this->map_path_.empty())
...
void c_lio::LioSamMapOptimizationNode::savePCD(
    std::shared_ptr<c_lio::srv::SavePCD::Request> req,
    std::shared_ptr<c_lio::srv::SavePCD::Response> res)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(c_lio::LioSamMapOptimizationNode)
