...
void RegistrationEngine::init(RegistrationMethod method, const RegistrationParams& p,
  ...
  // C_LIO_HAS_CUDA gates native CUDA methods (GICP_CUDA, ROBUST_ICP_CUDA).
  // C_LIO_HAS_NDT_CUDA gates only the external ndt_cuda_ros2 method.
  switch (method_) {
