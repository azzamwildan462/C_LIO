...
namespace c_lio
{
      ...
      pcl::PointCloud<PointType>::ConstPtr cloud)
  {
    ...
    {
      desc.sc_descriptor = c_lio::sc::computeScanContext(cloud, params_.max_range);
      desc.ring_key = c_lio::sc::computeRingKey(desc.sc_descriptor);
      desc.sector_key = c_lio::sc::computeSectorKey(desc.sc_descriptor);
      break;
    }
    }
      ...
      const AppearanceDescriptor &a, const AppearanceDescriptor &b)
  {
    ...
    case AppearanceMethod::STD_CUDA:
    {
      return c_lio::sc::computeScanContextDistance(
  ...
  {
    return c_lio::sc::prepareGravityAlignedScan(
  ...
  float AppearanceEngine::shiftToYaw(int shift) const
  {
    ...
    case AppearanceMethod::SC_PLUS_PLUS:
    case AppearanceMethod::SC_PLUS_PLUS_CUDA:
      return static_cast<float>(shift) * 2.f * M_PI / static_cast<float>(c_lio::sc::SC_NS);
    case AppearanceMethod::STD:
    case AppearanceMethod::STD_CUDA:
