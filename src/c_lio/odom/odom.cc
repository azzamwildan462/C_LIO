...
std::atomic<c_lio::OdomNode *> g_odom_node{nullptr};

c_lio::FusionMethod c_lio::parseFusionMethod(const std::string &s)
{
  if (s == "kf" || s == "KF")
    return c_lio::FusionMethod::KF;
  if (s == "ekf" || s == "EKF")
    return c_lio::FusionMethod::EKF;
  return c_lio::FusionMethod::GEO;
}

c_lio::MotionModelType c_lio::parseMotionModelType(const std::string &s)
{
  if (s == "ackermann" || s == "ACKERMANN")
    return c_lio::MotionModelType::ACKERMANN;
  if (s == "diff_drive" || s == "DIFF_DRIVE")
    return c_lio::MotionModelType::DIFF_DRIVE;
  if (s == "holonomic" || s == "HOLONOMIC")
    return c_lio::MotionModelType::HOLONOMIC;
  return c_lio::MotionModelType::NONE;
}
...
c_lio::OdomNode::OdomNode(const rclcpp::NodeOptions &options)
    : Node("c_lio_odom_node", options)
{
  ...
  this->lidar_sub = this->create_subscription<sensor_msgs::msg::PointCloud2>("pointcloud", rclcpp::SensorDataQoS(),
                                                                             std::bind(&c_lio::OdomNode::callbackPointCloud, this, std::placeholders::_1), lidar_sub_opt);
  ...
  this->kf_stamped_pub = this->create_publisher<c_lio::msg::KeyframeStamped>("kf_stamped", 10);
  ...
  this->publish_timer = this->create_wall_timer(std::chrono::duration<double>(0.01),
                                                std::bind(&c_lio::OdomNode::publishPose, this),
  ...
  if (this->occupancy_grid_enabled_)
  {
    ...
    double og_rate = 5.0;
    c_lio::declare_param(this, "occupancy_grid/update_rate", og_rate, 5.0);

    this->occupancy_grid_timer_ = this->create_wall_timer(
        std::chrono::duration<double>(1.0 / og_rate),
        std::bind(&c_lio::OdomNode::publishOccupancyGrid, this),
  ...
  if (this->ext_odom_enabled_)
  {
    ...
    this->ext_odom_sub_ = this->create_subscription<geometry_msgs::msg::TwistWithCovarianceStamped>(
        ...
        std::bind(&c_lio::OdomNode::callbackExternalOdom, this, std::placeholders::_1),
        odom_sub_opt);
  }
  ...
  if (this->gps_enabled_)
  {
    ...
    this->gps_sub_ = this->create_subscription<sensor_msgs::msg::NavSatFix>(
        ...
        std::bind(&c_lio::OdomNode::callbackGPS, this, std::placeholders::_1),
        gps_sub_opt);
  ...
  // Initialize registration engine
  {
    ...
    if (this->registration_method_ == "robust_icp" || this->registration_method_ == "robust_icp_cuda")
      c_lio::declare_param(this, "odom/robust_icp/kernel_scale", kernel_scale, 0.0);

    c_lio::RegistrationParams rp;
    ...
    auto method = c_lio::parseRegistrationMethod(this->registration_method_);
    ...
    RCLCPP_INFO(this->get_logger(), "[odom] Registration method: %s",
                c_lio::registrationMethodToString(method).c_str());
  }
  ...
  if (this->submap_method_ == "voxel_hash_map")
  {
    ...
    int vm_max_pts = 20;
    c_lio::declare_param(this, "odom/submap/voxel_hash_map/voxel_size", vm_voxel_size, 1.0);
    c_lio::declare_param(this, "odom/submap/voxel_hash_map/max_distance", vm_max_dist, 100.0);
    c_lio::declare_param(this, "odom/submap/voxel_hash_map/max_points_per_voxel", vm_max_pts, 20);
    ...
    {
      this->voxel_map_ = std::make_unique<c_lio::VoxelHashMap>(vm_voxel_size, vm_max_dist, vm_max_pts);
  ...
  if (this->fusion_method_ == c_lio::FusionMethod::KF)
  {
    this->kf_P_.setZero();
  ...
  // Initialize EKF
  if (this->fusion_method_ == c_lio::FusionMethod::EKF)
  {
  ...
  if (this->imu_preintegration_mode_ == "gtsam")
  {
    ...
    double sa = (this->fusion_method_ == c_lio::FusionMethod::KF) ? this->kf_sigma_accel_ : 0.1;
    double sg = (this->fusion_method_ == c_lio::FusionMethod::KF) ? this->kf_sigma_gyro_ : 0.01;
  ...
  this->set_mode_srv_ = this->create_service<c_lio::srv::SetMode>(
      "c_lio_odom/set_mode",
      std::bind(&c_lio::OdomNode::srvSetMode, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);
  this->relocalize_srv_ = this->create_service<c_lio::srv::Relocalize>(
      "c_lio_odom/relocalize",
      std::bind(&c_lio::OdomNode::srvRelocalize, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);
  this->set_pose_srv_ = this->create_service<c_lio::srv::SetPose>(
      "c_lio_odom/set_pose",
      std::bind(&c_lio::OdomNode::srvSetPose, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);
  this->get_state_srv_ = this->create_service<c_lio::srv::GetState>(
      "c_lio_odom/get_state",
      std::bind(&c_lio::OdomNode::srvGetState, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);
  this->new_map_srv_ = this->create_service<c_lio::srv::NewMap>(
      "c_lio_odom/new_map",
      std::bind(&c_lio::OdomNode::srvNewMap, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);
  this->new_map_w_zero_srv_ = this->create_service<c_lio::srv::NewMapWZero>(
      "c_lio_odom/new_map_w_zero",
      std::bind(&c_lio::OdomNode::srvNewMapWZero, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, this->service_cb_group_);

  // SavePCD clients (calls MapNode + GraphSlam save services)
  this->save_pcd_client_ = this->create_client<c_lio::srv::SavePCD>(
      "save_pcd_map", rmw_qos_profile_services_default, this->service_cb_group_);
  this->save_corrected_pcd_client_ = this->create_client<c_lio::srv::SavePCD>(
  ...
  this->initialpose_sub_ = this->create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
      "/initialpose", 10,
      std::bind(&c_lio::OdomNode::callbackInitialPose, this, std::placeholders::_1),
      initialpose_opt);
  ...
  this->scan_match_pub_ = this->create_publisher<std_msgs::msg::Float32>(
      "c_lio/odom_node/scan_match_score", rclcpp::QoS(10));
      ...
      this->prior_map_cloud_ && !this->prior_map_cloud_->empty())
  {
    ...
    this->prior_map_pub_timer_ = this->create_wall_timer(
        ...
        std::bind(&c_lio::OdomNode::publishPriorMap, this),
        this->aux_timer_cb_group_);
  }
  ...
  if (cl_enabled)
  {
    ...
    this->continuous_localize_timer_ = this->create_wall_timer(
        ...
        std::bind(&c_lio::OdomNode::continuousLocalize, this),
    ...
    c_lio::declare_param(this, "map/continuous_localize/enable_global_correction",
  ...
  if (this->submap_loc_enabled_ && this->use_prior_map_ && this->map_mode_ == "localization")
  {
    ...
    this->submap_loc_timer_ = this->create_wall_timer(
        ...
        std::bind(&c_lio::OdomNode::submapLocalizeTick, this),
...
void c_lio::OdomNode::getParams()
{

  // Debug
  c_lio::declare_param(this, "debug/odom", this->debug_, false);
  c_lio::declare_param(this, "debug/print_odom", this->debug_print_, false);
  c_lio::declare_param(this, "deep_debug/odom", this->deep_debug_, false);
  c_lio::declare_param(this, "odom/use_2d_imu", this->use_2d_imu_, false);
  c_lio::declare_param(this, "odom/use_imu", this->use_imu_, true);

  // Version
  c_lio::declare_param(this, "version", this->version_, "0.0.0");

  // Frames
  c_lio::declare_param(this, "frames/odom", this->odom_frame, "odom");
  c_lio::declare_param(this, "frames/baselink", this->baselink_frame, "base_link");
  c_lio::declare_param(this, "frames/lidar", this->lidar_frame, "lidar");
  c_lio::declare_param(this, "frames/imu", this->imu_frame, "imu");

  // Deskew Flag
  c_lio::declare_param(this, "pointcloud/deskew", this->deskew_, true);

  // Gravity
  c_lio::declare_param(this, "odom/gravity", this->gravity_, 9.80665);

  // Compute time offset between lidar and imu
  c_lio::declare_param(this, "odom/computeTimeOffset", this->time_offset_, false);

  // IMU gravity removed: set true if IMU driver already removes gravity from accel
  // (accel Z ≈ 0 at rest instead of ≈ 9.8). C_LIO will add gravity back using IMU orientation.
  c_lio::declare_param(this, "odom/imu/gravityRemoved", this->imu_gravity_removed_, false);
  ...
  // instead of m/s^2. C_LIO will scale accel by gravity_ before any further processing.
  c_lio::declare_param(this, "odom/imu/accelInG", this->imu_accel_in_g_, false);
  ...
  // Keyframe Threshold
  c_lio::declare_param(this, "odom/keyframe/threshD", this->keyframe_thresh_dist_, 0.1);
  c_lio::declare_param(this, "odom/keyframe/threshR", this->keyframe_thresh_rot_, 1.0);

  // Submap
  c_lio::declare_param(this, "odom/submap/method", this->submap_method_, std::string("keyframe"));
  c_lio::declare_param(this, "odom/submap/keyframe/knn", this->submap_knn_, 10);
  c_lio::declare_param(this, "odom/submap/keyframe/kcv", this->submap_kcv_, 10);
  c_lio::declare_param(this, "odom/submap/keyframe/kcc", this->submap_kcc_, 10);
  c_lio::declare_param(this, "odom/submap/recent/n", this->submap_recent_n_, 10);
  ...
  c_lio::declare_param(this, "odom/localization/roi_refresh_dist", this->loc_roi_refresh_dist_, 5.0);
  // Localization memory bound: # of recent live keyframes to keep clouds for
  // (older ones are freed). <=0 = unbounded.
  c_lio::declare_param(this, "odom/localization/keyframe_window", this->loc_keyframe_window_, 100);
  ...
  c_lio::declare_param(this, "map/dense/filtered", this->densemap_filtered_, true);

  // Wait until movement to publish map
  c_lio::declare_param(this, "map/waitUntilMove", this->wait_until_move_, false);

  // Crop Box Filter
  c_lio::declare_param(this, "odom/preprocessing/cropBoxFilter/size", this->crop_size_, 1.0);

  // Voxel Grid Filter
  c_lio::declare_param(this, "pointcloud/voxelize", this->vf_use_, true);
  c_lio::declare_param(this, "odom/preprocessing/voxelFilter/res", this->vf_res_, 0.05);

  // GPU preprocessing (deskewing + voxel filter)
  c_lio::declare_param(this, "odom/preprocessing/gpu", this->gpu_preprocess_, false);
#if !C_LIO_HAS_CUDA
  ...
  // Prefilter (noise removal)
  {
    ...
    c_lio::declare_param(this, "odom/prefilter/method", prefilter_method, std::string("none"));
    c_lio::PrefilterParams pf_params;
    c_lio::declare_param(this, "odom/prefilter/mean_k", pf_params.mean_k, 10);
    c_lio::declare_param(this, "odom/prefilter/stddev_mul", pf_params.stddev_mul, 1.0);
    c_lio::declare_param(this, "odom/prefilter/radius", pf_params.radius, 0.5);
    c_lio::declare_param(this, "odom/prefilter/min_neighbors", pf_params.min_neighbors, 3);
    c_lio::declare_param(this, "odom/prefilter/dror_min_radius", pf_params.dror_min_radius, 0.1);
    c_lio::declare_param(this, "odom/prefilter/dror_max_radius", pf_params.dror_max_radius, 2.0);
    c_lio::declare_param(this, "odom/prefilter/dror_range_scale", pf_params.dror_range_scale, 0.01);
    c_lio::declare_param(this, "odom/prefilter/dror_min_neighbors", pf_params.dror_min_neighbors, 3);
    this->prefilter_.init(c_lio::parsePrefilterMethod(prefilter_method), pf_params);
    if (this->prefilter_.isEnabled())
      RCLCPP_INFO(this->get_logger(), "[odom] Prefilter: %s", prefilter_method.c_str());
  }

  // Adaptive Parameters
  c_lio::declare_param(this, "adaptive", this->adaptive_params_, true);
  ...
  c_lio::declare_param(this, "extrinsics/baselink2imu/t", baselink2imu_t, t_default);
  c_lio::declare_param(this, "extrinsics/baselink2imu/rpy", baselink2imu_rpy, rpy_default);
  c_lio::declare_param(this, "extrinsics/baselink2imu/R", baselink2imu_R, R_default);
  ...
  c_lio::declare_param(this, "extrinsics/baselink2lidar/t", baselink2lidar_t, t_default);
  c_lio::declare_param(this, "extrinsics/baselink2lidar/rpy", baselink2lidar_rpy, rpy_default);
  c_lio::declare_param(this, "extrinsics/baselink2lidar/R", baselink2lidar_R, R_default);
  ...
  // IMU
  c_lio::declare_param(this, "odom/imu/calibration/accel", this->calibrate_accel_, true);
  c_lio::declare_param(this, "odom/imu/calibration/gyro", this->calibrate_gyro_, true);
  c_lio::declare_param(this, "odom/imu/calibration/time", this->imu_calib_time_, 3.0);
  c_lio::declare_param(this, "odom/imu/bufferSize", this->imu_buffer_size_, 2000);
  c_lio::declare_param(this, "odom/imu/differential_orientation", this->imu_differential_orientation_, false);
  c_lio::declare_param(this, "odom/imu/preintegration", this->imu_preintegration_mode_, std::string("simple"));
  ...
  c_lio::declare_param(this, "odom/imu/approximateGravity", this->gravity_align_, true);
  c_lio::declare_param(this, "imu/calibration", this->imu_calibrate_, true);
  c_lio::declare_param(this, "imu/intrinsics/accel/bias", prior_accel_bias, accel_default);
  c_lio::declare_param(this, "imu/intrinsics/gyro/bias", prior_gyro_bias, gyro_default);

  // scale-misalignment matrix
  std::vector<double> imu_sm_default{1., 0., 0., 0., 1., 0., 0., 0., 1.};
  std::vector<double> imu_sm;

  c_lio::declare_param(this, "imu/intrinsics/accel/sm", imu_sm, imu_sm_default);
  ...
  // Registration method
  c_lio::declare_param(this, "odom/registration_method", this->registration_method_, std::string("gicp"));

  // NDT params
  c_lio::declare_param(this, "odom/ndt/resolution", this->ndt_resolution_, 2.0);
  c_lio::declare_param(this, "odom/ndt/num_threads", this->ndt_num_threads_, 4);
  c_lio::declare_param(this, "odom/ndt/search_method", this->ndt_search_method_, std::string("DIRECT7"));
  c_lio::declare_param(this, "odom/ndt/step_size", this->ndt_step_size_, 0.1);

  // GICP
  c_lio::declare_param(this, "odom/gicp/minNumPoints", this->gicp_min_num_points_, 100);
  c_lio::declare_param(this, "odom/gicp/kCorrespondences", this->gicp_k_correspondences_, 20);
  c_lio::declare_param(this, "odom/gicp/maxCorrespondenceDistance", this->gicp_max_corr_dist_,
                      std::sqrt(std::numeric_limits<double>::max()));
  c_lio::declare_param(this, "odom/gicp/maxIterations", this->gicp_max_iter_, 64);
  c_lio::declare_param(this, "odom/gicp/transformationEpsilon", this->gicp_transformation_ep_, 0.0005);
  c_lio::declare_param(this, "odom/gicp/rotationEpsilon", this->gicp_rotation_ep_, 0.0005);
  c_lio::declare_param(this, "odom/gicp/initLambdaFactor", this->gicp_init_lambda_factor_, 1e-9);

  // Geometric Observer
  c_lio::declare_param(this, "odom/geo/Kp", this->geo_Kp_, 1.0);
  c_lio::declare_param(this, "odom/geo/Kv", this->geo_Kv_, 1.0);
  c_lio::declare_param(this, "odom/geo/Kq", this->geo_Kq_, 1.0);
  c_lio::declare_param(this, "odom/geo/Kab", this->geo_Kab_, 1.0);
  c_lio::declare_param(this, "odom/geo/Kgb", this->geo_Kgb_, 1.0);
  c_lio::declare_param(this, "odom/geo/abias_max", this->geo_abias_max_, 1.0);
  c_lio::declare_param(this, "odom/geo/gbias_max", this->geo_gbias_max_, 1.0);

  // Fusion strategy: "geo", "kf", "ekf"
  {
    std::string fusion_method_str;
    c_lio::declare_param(this, "odom/fusion/method", fusion_method_str, std::string("geo"));
    this->fusion_method_ = c_lio::parseFusionMethod(fusion_method_str);
    RCLCPP_INFO(this->get_logger(), "[odom] Fusion method: %s", fusion_method_str.c_str());
  }


  // Pose safety gate
  c_lio::declare_param(this, "odom/fusion/gate/enabled", this->gate_enabled_, false);
  c_lio::declare_param(this, "odom/fusion/gate/fitness_threshold", this->gate_fitness_threshold_, 1.0);
  c_lio::declare_param(this, "odom/fusion/gate/min_spaciousness", this->gate_min_spaciousness_, 0.5);
  c_lio::declare_param(this, "odom/fusion/gate/max_translation", this->gate_max_translation_, 5.0);
  c_lio::declare_param(this, "odom/fusion/gate/max_rotation_deg", this->gate_max_rotation_deg_, 45.0);
  c_lio::declare_param(this, "odom/fusion/gate/max_consecutive_rejects", this->gate_max_consecutive_rejects_, 10);
  // ABG LiDAR pose tracker (prediction-based gate)
  {
    double ap, bp, gp, aq, bq, gq, mpr, mrr;
    c_lio::declare_param(this, "odom/fusion/gate/tracker/alpha_p", ap, 0.5);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/beta_p", bp, 0.4);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/gamma_p", gp, 0.1);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/alpha_q", aq, 0.5);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/beta_q", bq, 0.3);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/gamma_q", gq, 0.05);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/max_pos_residual", mpr, 2.0);
    c_lio::declare_param(this, "odom/fusion/gate/tracker/max_rot_residual_deg", mrr, 30.0);
  ...
  // KF parameters
  c_lio::declare_param(this, "odom/fusion/kf/sigma_accel", this->kf_sigma_accel_, 0.1);
  c_lio::declare_param(this, "odom/fusion/kf/sigma_gyro", this->kf_sigma_gyro_, 0.01);
  c_lio::declare_param(this, "odom/fusion/kf/sigma_accel_bias", this->kf_sigma_accel_bias_, 0.001);
  c_lio::declare_param(this, "odom/fusion/kf/sigma_gyro_bias", this->kf_sigma_gyro_bias_, 0.0001);
  c_lio::declare_param(this, "odom/fusion/kf/sigma_pos_meas", this->kf_sigma_pos_meas_, 0.1);
  c_lio::declare_param(this, "odom/fusion/kf/sigma_rot_meas", this->kf_sigma_rot_meas_, 0.02);

  // EKF parameters
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_accel", this->ekf_params_.sigma_accel, 0.1);
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_gyro", this->ekf_params_.sigma_gyro, 0.01);
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_accel_bias", this->ekf_params_.sigma_accel_bias, 0.001);
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_gyro_bias", this->ekf_params_.sigma_gyro_bias, 0.0001);
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_pos_base", this->ekf_params_.sigma_pos_base, 0.1);
  c_lio::declare_param(this, "odom/fusion/ekf/sigma_rot_base", this->ekf_params_.sigma_rot_base, 0.02);
  c_lio::declare_param(this, "odom/fusion/ekf/fitness_weight", this->ekf_params_.fitness_weight, 10.0);
  c_lio::declare_param(this, "odom/fusion/ekf/space_weight", this->ekf_params_.space_weight, 0.5);
  c_lio::declare_param(this, "odom/fusion/ekf/degeneracy_weight", this->ekf_params_.degeneracy_weight, 5.0);
  c_lio::declare_param(this, "odom/fusion/ekf/gate_threshold", this->ekf_params_.gate_threshold, 22.46);
  c_lio::declare_param(this, "odom/fusion/ekf/max_fitness", this->ekf_params_.max_fitness, 5.0);
  {
    int max_rej = 5;
    c_lio::declare_param(this, "odom/fusion/ekf/max_consecutive_rejects", max_rej, 5);
  ...
  // Motion model constraint
  {
    ...
    c_lio::declare_param(this, "motion_model/type", mm_type_str, std::string("none"));
    this->motion_model_type_ = c_lio::parseMotionModelType(mm_type_str);
    ...
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_forward_vel", v, 30.0);
      m.ack_max_fwd_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_reverse_vel", v, 5.0);
      m.ack_max_rev_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_lateral_vel", v, 0.5);
      m.ack_max_lat_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_vertical_vel", v, 1.0);
      m.ack_max_vert_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_forward_accel", v, 8.0);
      m.ack_max_fwd_accel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_lateral_accel", v, 3.0);
      m.ack_max_lat_accel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_yaw_rate", v, 1.5);
      m.ack_max_yaw_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_roll_rate", v, 0.3);
      m.ack_max_roll_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/ackermann/max_pitch_rate", v, 0.3);
    ...
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_forward_vel", v, 5.0);
      m.dd_max_fwd_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_reverse_vel", v, 2.0);
      m.dd_max_rev_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_lateral_vel", v, 0.1);
      m.dd_max_lat_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_vertical_vel", v, 0.5);
      m.dd_max_vert_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_forward_accel", v, 5.0);
      m.dd_max_fwd_accel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_lateral_accel", v, 1.0);
      m.dd_max_lat_accel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_yaw_rate", v, 3.0);
      m.dd_max_yaw_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_roll_rate", v, 0.2);
      m.dd_max_roll_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/diff_drive/max_pitch_rate", v, 0.2);
    ...
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_horizontal_vel", v, 5.0);
      m.holo_max_horiz_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_vertical_vel", v, 0.5);
      m.holo_max_vert_vel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_horizontal_accel", v, 5.0);
      m.holo_max_horiz_accel = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_yaw_rate", v, 3.0);
      m.holo_max_yaw_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_roll_rate", v, 0.2);
      m.holo_max_roll_rate = v;
    }
    {
      double v;
      c_lio::declare_param(this, "motion_model/holonomic/max_pitch_rate", v, 0.2);
      m.holo_max_pitch_rate = v;
    }

    if (this->motion_model_type_ != c_lio::MotionModelType::NONE)
    {
  ...
  // Localization registration helper (continuous loc, submap loc, SC reloc)
  {
    ...
    c_lio::declare_param(this, "odom/localization/registration_method", loc_reg_method, std::string("gicp"));

    auto setupEngine = [&](c_lio::RegistrationEngine &eng, const std::string &method, double corr_dist)
    {
      c_lio::RegistrationParams rp;
      rp.gicp_k_correspondences = this->gicp_k_correspondences_;
      ...
      rp.ndt_search_method = this->ndt_search_method_;
      rp.ndt_step_size = this->ndt_step_size_;
      eng.init(c_lio::parseRegistrationMethod(method), rp, this->get_logger());
    };
  ...
  // Map load/save
  c_lio::declare_param(this, "map/mode", this->map_mode_, std::string("localization"));
  ...
  if (this->map_path_.empty())
  {
    ...
    if (home)
    {
      this->map_path_ = std::string(home) + "/.ros/c_lio_map.pcd";
      RCLCPP_INFO(this->get_logger(), "map/path not set, defaulting to: %s", this->map_path_.c_str());
    }
  }
  c_lio::declare_param(this, "map/use_corrected", this->use_corrected_, true);
  c_lio::declare_param(this, "map/auto_save_interval", this->kfdb_auto_save_interval_, 30.0);
  c_lio::declare_param(this, "map/voxel_size", this->map_voxel_size_, 0.25);
  c_lio::declare_param(this, "map/chunk_size", this->map_chunk_size_, 20.0);
  ...
  c_lio::declare_param(this, "map/publish_debug_interval_ms", this->prior_map_pub_interval_ms_, -1);
  // Downsample resolution for the debug map publish (m). Coarser = lighter RViz.
  c_lio::declare_param(this, "map/publish_debug_leaf", this->prior_map_pub_leaf_, 1.0);

  double init_x = 0., init_y = 0., init_z = 0., init_yaw = 0.;
  c_lio::declare_param(this, "map/initial_pose/x", init_x, 0.0);
  c_lio::declare_param(this, "map/initial_pose/y", init_y, 0.0);
  c_lio::declare_param(this, "map/initial_pose/z", init_z, 0.0);
  ...
  c_lio::declare_param(this, "map/relocalize/sc_max_range", sc_max_range_d, 40.0);
  this->sc_max_range_ = static_cast<float>(sc_max_range_d);
  c_lio::declare_param(this, "map/relocalize/sc_num_candidates", this->sc_num_candidates_, 10);
  c_lio::declare_param(this, "map/relocalize/sc_distance_threshold", this->sc_distance_threshold_, 0.3);
  c_lio::declare_param(this, "map/relocalize/sc_max_attempts", this->sc_max_attempts_, 10);
  double sc_ground_ht = 0.3;
  c_lio::declare_param(this, "map/relocalize/sc_ground_height_threshold", sc_ground_ht, 0.3);
  this->sc_ground_height_threshold_ = static_cast<float>(sc_ground_ht);
  c_lio::declare_param(this, "map/relocalize/sc_search_window", this->sc_search_window_, 7);

  // Appearance engine (loop closure descriptor)
  {
    std::string appearance_method;
    c_lio::declare_param(this, "map/appearance_method", appearance_method, std::string("sc++"));
    c_lio::AppearanceParams ap;
    ...
    this->appearance_.init(c_lio::parseAppearanceMethod(appearance_method), ap, this->get_logger());
  }

  // Continuous localization (Bayesian)
  c_lio::declare_param(this, "map/continuous_localize", this->continuous_localize_, true);
  c_lio::declare_param(this, "map/continuous_localize/on_mapping", this->continuous_localize_on_mapping_, false);
  c_lio::declare_param(this, "map/continuous_localize/interval", this->continuous_localize_interval_, 2.0);
  c_lio::declare_param(this, "map/continuous_localize/fitness_threshold", this->continuous_localize_fitness_thresh_, 0.15);
  c_lio::declare_param(this, "map/continuous_localize/max_correction", this->continuous_localize_max_correction_, 2.0);
  double vp_prior = 0.9;
  c_lio::declare_param(this, "map/continuous_localize/virtual_place_prior", vp_prior, 0.9);
  this->bayes_virtual_place_prior_ = static_cast<float>(vp_prior);
  double loop_thr = 0.5;
  c_lio::declare_param(this, "map/continuous_localize/loop_threshold", loop_thr, 0.5);
  this->bayes_loop_threshold_ = static_cast<float>(loop_thr);
  c_lio::declare_param(this, "map/continuous_localize/min_consecutive", this->bayes_min_consecutive_, 2);
  double sc_dist_thr = 0.4;
  c_lio::declare_param(this, "map/continuous_localize/sc_distance_threshold", sc_dist_thr, 0.4);
  this->bayes_sc_dist_threshold_ = static_cast<float>(sc_dist_thr);
  c_lio::declare_param(this, "map/continuous_localize/sc_top_k", this->bayes_sc_top_k_, 5);
  c_lio::declare_param(this, "map/continuous_localize/g2o_verification", this->g2o_verification_enabled_, true);
  c_lio::declare_param(this, "map/continuous_localize/g2o_chi2_threshold", this->g2o_chi2_threshold_, 50.0);
  c_lio::declare_param(this, "map/continuous_localize/g2o_iterations", this->g2o_iterations_, 10);

  c_lio::declare_param(this, "frames/map", this->map_frame_, std::string("map"));

  // Submap-based relocalization (GPS-denied)
  c_lio::declare_param(this, "map/submap_localize", this->submap_loc_enabled_, false);
  c_lio::declare_param(this, "map/submap_localize/interval", this->submap_loc_interval_, 2.0);
  c_lio::declare_param(this, "map/submap_localize/group_size", this->submap_loc_group_size_, 10);
  c_lio::declare_param(this, "map/submap_localize/search_radius", this->submap_loc_search_radius_, 50.0);
  c_lio::declare_param(this, "map/submap_localize/fitness_threshold", this->submap_loc_fitness_thresh_, 0.15);
  c_lio::declare_param(this, "map/submap_localize/prob_threshold", this->submap_loc_prob_threshold_, 0.6);
  c_lio::declare_param(this, "map/submap_localize/motion_error_threshold", this->submap_loc_motion_error_thresh_, 1.0);
  c_lio::declare_param(this, "map/submap_localize/motion_rot_threshold", this->submap_loc_motion_rot_thresh_, 5.0);
  c_lio::declare_param(this, "map/submap_localize/min_motion_validations", this->submap_loc_min_motion_valid_, 3);
  c_lio::declare_param(this, "map/submap_localize/prob_drop_threshold", this->submap_loc_prob_drop_thresh_, 0.3);
  c_lio::declare_param(this, "map/submap_localize/max_correction", this->submap_loc_max_correction_, 5.0);
  {
    double sc_thresh = 0.5;
    c_lio::declare_param(this, "map/submap_localize/sc_distance_threshold", sc_thresh, 0.5);
    this->submap_loc_sc_dist_thresh_ = static_cast<float>(sc_thresh);
  }
  c_lio::declare_param(this, "map/submap_localize/sc_accum_scans", this->submap_loc_sc_accum_scans_, 5);

  // External odometry (wheel encoder / visual odom)
  c_lio::declare_param(this, "odom/external_odom/enabled", this->ext_odom_enabled_, false);
  c_lio::declare_param(this, "odom/external_odom/topic", this->ext_odom_topic_, std::string("/odom"));
  {
    std::vector<double> scale_default{1.0, 1.0, 1.0};
    std::vector<double> scale_vec;
    c_lio::declare_param(this, "odom/external_odom/odom2meter", scale_vec, scale_default);
    ...
    c_lio::declare_param(this, "extrinsics/baselink2odom/t", odom_t, t_default);
    c_lio::declare_param(this, "extrinsics/baselink2odom/rpy", odom_rpy, rpy_default);
  ...
  // GPS
  c_lio::declare_param(this, "gps/enabled", this->gps_enabled_, false);
  c_lio::declare_param(this, "gps/topic", this->gps_topic_, std::string("fix"));
  c_lio::declare_param(this, "gps/origin/latitude", this->gps_origin_param_lat_, 0.0);
  c_lio::declare_param(this, "gps/origin/longitude", this->gps_origin_param_lon_, 0.0);
  c_lio::declare_param(this, "gps/origin/altitude", this->gps_origin_param_alt_, 0.0);
  double gps_sr = 30.0;
  c_lio::declare_param(this, "gps/search_radius", gps_sr, 30.0);
  this->gps_search_radius_ = static_cast<float>(gps_sr);
  double gps_ma = 5.0;
  c_lio::declare_param(this, "gps/min_accuracy", gps_ma, 5.0);
  ...
  if (this->occupancy_grid_enabled_)
  {
    c_lio::OccupancyGridGenerator::Params ogp;
    c_lio::declare_param(this, "occupancy_grid/grid_size_x", ogp.grid_size_x, 100.0);
    c_lio::declare_param(this, "occupancy_grid/grid_size_y", ogp.grid_size_y, 100.0);
    c_lio::declare_param(this, "occupancy_grid/resolution", ogp.resolution, 0.2);
    c_lio::declare_param(this, "occupancy_grid/ground_threshold", ogp.ground_threshold, -0.3);
    c_lio::declare_param(this, "occupancy_grid/obstacle_min_height", ogp.obstacle_min_height, 0.1);
    c_lio::declare_param(this, "occupancy_grid/obstacle_max_height", ogp.obstacle_max_height, 3.0);
    c_lio::declare_param(this, "occupancy_grid/p_occupied", ogp.p_occupied, 0.7);
    c_lio::declare_param(this, "occupancy_grid/p_free", ogp.p_free, 0.3);
    c_lio::declare_param(this, "occupancy_grid/p_prior", ogp.p_prior, 0.5);
    c_lio::declare_param(this, "occupancy_grid/lo_clamped_min", ogp.lo_clamped_min, -4.0);
    c_lio::declare_param(this, "occupancy_grid/lo_clamped_max", ogp.lo_clamped_max, 4.0);
    c_lio::declare_param(this, "occupancy_grid/decay_rate", ogp.decay_rate, 0.0);
    c_lio::declare_param(this, "occupancy_grid/obstacle_margin", ogp.obstacle_margin, 0.3);
    c_lio::declare_param(this, "occupancy_grid/height_offset", ogp.height_offset, 0.0);
    c_lio::declare_param(this, "occupancy_grid/adaptive_ground", ogp.adaptive_ground, false);
    c_lio::declare_param(this, "occupancy_grid/ground_slope_threshold", ogp.ground_slope_threshold, 10.0);
    c_lio::declare_param(this, "occupancy_grid/scan_angle_target", ogp.scan_angle_target, 0.0);
    c_lio::declare_param(this, "occupancy_grid/scan_angle_tolerance", ogp.scan_angle_tolerance, 180.0);
    ogp.frame_id = this->map_frame_;
    this->occupancy_grid_gen_ = std::make_unique<c_lio::OccupancyGridGenerator>(ogp);
  }
}

void c_lio::OdomNode::callbackGPS(const sensor_msgs::msg::NavSatFix::SharedPtr msg)
{
  float h_acc = 0.0f;
...
bool c_lio::OdomNode::getGPSAtTime(double timestamp, GPSMeasurement &out)
{
  std::lock_guard<std::mutex> lock(this->gps_buffer_mtx_);
...
bool c_lio::OdomNode::gpsToLocal(double lat, double lon, double alt,
...
void c_lio::OdomNode::start()
{

  printf("\033[2J\033[1;1H");
  std::cout << std::endl
            << "+-------------------------------------------------------------------+" << std::endl;
  std::cout << "|               Compact LiDAR-Inertial Odometry v" << this->version_ << "               |"
            << std::endl;
  std::cout << "+-------------------------------------------------------------------+" << std::endl;
}

#include "rclcpp_components/register_node_macro.hpp"
RCLCPP_COMPONENTS_REGISTER_NODE(c_lio::OdomNode)
