...
void c_lio::OdomNode::initializeInputTarget()
{
...
void c_lio::OdomNode::setInputSource()
{
  this->engine_.setInputSource(this->current_scan);
}

void c_lio::OdomNode::getNextPose()
{
...
bool c_lio::OdomNode::imuMeasFromTimeRange(double start_time, double end_time,
...
c_lio::OdomNode::integrateImu(double start_time, Eigen::Quaternionf q_init, Eigen::Vector3f p_init,
...
std::vector<Eigen::Matrix4f, Eigen::aligned_allocator<Eigen::Matrix4f>>
c_lio::OdomNode::integrateImuInternal(Eigen::Quaternionf q_init, Eigen::Vector3f p_init, Eigen::Vector3f v_init,
...
void c_lio::OdomNode::propagateGICP()
{
...
void c_lio::OdomNode::propagateState()
{
...
void c_lio::OdomNode::updateState()
{
  switch (this->fusion_method_)
  {
  case c_lio::FusionMethod::KF:
    this->updateStateKF();
    break;
  case c_lio::FusionMethod::EKF:
    this->updateStateEKF();
    break;
  case c_lio::FusionMethod::GEO:
  default:
    this->updateStateGeo();
    break;
  }
...
void c_lio::OdomNode::updateStateGeo()
{
...
void c_lio::OdomNode::updateStateKF()
{
  std::lock_guard<std::mutex> lock(this->geo.mtx);
...
void c_lio::OdomNode::updateStateEKF()
{
  std::lock_guard<std::mutex> lock(this->geo.mtx);
  ...
  double scatter = c_lio::ErrorStateEkf::computeScanScatter(this->current_scan);

  auto [sigma_pos, sigma_rot] = c_lio::ErrorStateEkf::computeMeasurementNoise(
...
void c_lio::OdomNode::propagateStateKF(double dt)
{
...
bool c_lio::OdomNode::evaluatePoseGate()
{
...
void c_lio::OdomNode::applyMotionModelConstraint()
{
...
void c_lio::OdomNode::applyMotionModelConstraintImu(Eigen::Vector3f &v, const Eigen::Quaternionf &q)
{
...
void c_lio::OdomNode::setAdaptiveParams()
{
