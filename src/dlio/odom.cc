    ...
    : Node("dlio_odom_node", options)
{
  ...
  else
  {
    ...
    if (this->ndt_search_method_ == "KDTREE")
      search = pclomp::KDTREE;
    else if (this->ndt_search_method_ == "DIRECT1")
      search = pclomp::DIRECT1;
    else if (this->ndt_search_method_ == "DIRECT26")
      search = pclomp::DIRECT26;
